  ...
  it "works good" do
    expect do
      ...
      organization = builder.build_organization(
        name: "小学校",
        type: Meibo::JapanProfile::V1_2_Ed2::Organization::TYPES[:school],
      ...
      classroom = course.build_classroom(
        ...
        class_type: Meibo::JapanProfile::V1_2_Ed2::Classroom::TYPES[:homeroom]
      )
      ...
      user.build_demographic(sex: Meibo::JapanProfile::V1_2_Ed2::Demographic::SEX[:male])
      ...
      classroom.build_enrollment(
        user: user,
        role: Meibo::JapanProfile::V1_2_Ed2::Enrollment::ROLES[:student]
      )
