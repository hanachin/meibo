...
RSpec.describe Meibo::DataSet do
  describe "#check_semantically_consistent" do
    ...
    it "raise error if sourcedId is blank" do
      data_set = Meibo::DataSet.new([build(:meibo_academic_session, sourced_id: nil)], roster:)
      expect do
